    ...
    <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100 sm:p-6">
      ...
      <div className="mt-5 overflow-x-auto">
          ...
          <tbody>
            {loading
              ...
              : filtered.map((b, i) => (
                  ...
                  >
                    <td className="py-3.5 pr-4 font-mono text-xs font-semibold text-primary-700">{b.id}</td>
                    ...
                    <td className="py-3.5 pr-4 text-slate-500">{formatDate(b.checkIn)}</td>
                    <td className="py-3.5 pr-4 text-slate-500">{formatDate(b.checkOut)}</td>
                    <td className="py-3.5 pr-4 font-semibold text-primary-900">{formatCurrency(b.totalAmount)}</td>
                    <td className="py-3.5 pr-4">
        ...
        {!loading && filtered.length === 0 && (
          <p className="py-10 text-center text-sm text-slate-400">No bookings match your search.</p>
        )}
      </div>
    </div>
  );
