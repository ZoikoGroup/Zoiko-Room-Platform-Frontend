        ...
        <div className="animate-scale-in stagger-1 rounded-3xl bg-white p-8 shadow-2xl shadow-black/30 ring-1 ring-white/10 sm:p-10 dark:bg-slate-900">
          {successMessage ? (
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{successMessage}</p>
            ...
            <>
              <h2 className="font-heading text-2xl font-extrabold text-primary-900 dark:text-white">Register as Admin</h2>
              <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">
                Create your account to list properties. A super admin needs to approve it before you can sign in.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-7 space-y-4">
                ...
                <Button type="submit" variant="primary" size="lg" fullWidth loading={submitting}>
                  {submitting ? "Submitting" : "Create Admin Account"}
                </Button>
              </form>

              <p className="mt-5 text-center text-sm text-slate-500 dark:text-slate-400">
                Already have an account?{" "}
                <Link href="/login" className="font-semibold text-primary-700 hover:text-accent-600 dark:text-primary-300">
                  Sign in
                </Link>
              </p>
            </>
